...
if aba_selecionada == "Backtest portfólio":
    ...
    # === CORREÇÃO AQUI: hide_index=True ADICIONADO ===
    edited_df = st.data_editor(st.session_state.df_portfolio_input, num_rows="dynamic", use_container_width=True, hide_index=True)
...
if aba_selecionada == "Cobertura":
    ...
    with c_ativos_hist:
        ...
        fig_ativos_hist.update_layout(
            ...
            template="plotly_dark", plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,0,0,0)', height=700,
            xaxis=dict(showgrid=False, fixedrange=True),
            yaxis=dict(showgrid=True, gridcolor="#333", side="right", fixedrange=True),
            margin=dict(l=0, r=0, t=40, b=40), dragmode=False,
